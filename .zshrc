# get zsh to recognize delete key as delete key
...
# Customize terminal prompt without oh-my-zsh
# https://medium.com/@dpeachesdev/intro-to-zsh-without-oh-my-zsh-part-1-c039de5ee22e
# Set Foreground colors with '%F{_256-bit_or_hex-color-code}_sequence_%f'
# Set bacKground colors with '%K{_256-bit_or_hex-color-code}_sequence_%k'
# Set Bold text '%B_sequence_%b'

# Left prompt shows username and current working directory, showing up to 3 parent directories
PROMPT='%K{39}%B%F{231}%n:%f %F{227}%3~ > %f%k%b'
...
zstyle :compinstall filename '/home/adl/zshautoconfig'
